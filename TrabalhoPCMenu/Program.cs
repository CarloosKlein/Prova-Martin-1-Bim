    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("Usuarios Cadastrados: " + listaPessoas.Count);
                ...
                switch (opc)
                {
                    ...
                    case "02": //Editar
                        ...
                        Console.WriteLine(" 03 - Data de Cadastro");
                        Console.WriteLine(" 04 - Score do Funcionario");
                        ...
                        switch (opcAlterar)
                        {
                            ...
                            case "03": //Data de Cadastro
                                if (buscaID != null)
                                {
                                    Console.WriteLine();
                                    Console.Write("Digite a nova Data de Cadastro: ");
                                    string dataNova = Console.ReadLine(); //Variavel pra receber o texto
                                    buscaID.alteraData(dataNova); //Buscando o parametro da classe e inserir o novo Texto(Nome)
                                }
                                break;

                            case "04": //Score do Funcionario
                                if (buscaID != null)
                                {
                                    Console.WriteLine();
                                    Console.Write("Digite a porcentagem que deseja aumentar no Score: ");
                                    float somaScore = float.Parse(Console.ReadLine(), CultureInfo.InvariantCulture); //Recebe valor digitado e fazendo a conversão
                                    buscaID.PercentualScore(somaScore); //Buscando o parametro do calculo
                                }
                                else
                                {
                                    Console.WriteLine("Dados Invalidos");
                    ...
                    case "03": //Remover
                        ...
                        Console.WriteLine("Confirmar exclusão?");
                        Console.WriteLine("01 - Sim");
                        Console.WriteLine("02 - Não");
                        string opcRemove = Console.ReadLine();
                        if (opcRemove == "01")
                        {
                    ...
                    case "04": //Listar Usuarios Cadastrados
                        ...
                        {
                            Console.WriteLine(String.Format("{0} | {1} | {2} | {3} | {4}", p.Id, p.Nome, p.Salario, p.DataDeCadastro, p.ScoreFuncionario));
                        });
                        break;
        ...
        private static Pessoa incluirPessoa()
        {
            ...
            pessoa.DataDeCadastro = Console.ReadLine();

            Console.WriteLine();
            Console.WriteLine("Score: ");
            pessoa.ScoreFuncionario = float.Parse(Console.ReadLine());
